// Função de servidor — confirma o e-mail do usuário automaticamente no Supabase,
// pra ele não precisar clicar em nenhum link de confirmação.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error("Erro inesperado ao confirmar e-mail:", err);
